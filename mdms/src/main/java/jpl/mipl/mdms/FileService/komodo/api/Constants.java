 ...
 * 07/27/2017       Nick              Incremented server version to 3.1.13
 *                                    - TransactionManager.getFile() now returns the full filepath as part of its
 *                                    FILENOTFOUND error message, as the client expects that in order to parse the
 *                                    filename.  Resolves AR IDS-7970.
 *                                    - Stored Procedure changes to komodoProcsMySQL.sql for compatibility to new MariaDB/MySQL servers (Jeff Liu made the change)
 * 01/05/2021     William             Incremented server version to 3.1.14
 *                                    - TransactionManager.getFile() now returns the full filepath with the prefix "unknown_path" when the remote location is NULL
 *                                    This is an update on the fix made in version 3.1.13. Resolves AR IDS-8495
 * ============================================================================
 * </PRE>
 *
...
public interface Constants extends jpl.mipl.mdms.utils.Constants
{
   ...
   public static final String SERVERVERSIONSTR = "FEI5 release 3.1.14, January 2021";   //updated 01/05/2021
   ...
   public static final String COPYRIGHT = "Copyright 2002-2022 Jet Propulsion Laboratory, Caltech, NASA";
