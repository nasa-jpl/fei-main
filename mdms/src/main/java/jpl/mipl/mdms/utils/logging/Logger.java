...
public class Logger {
   ...
   protected static LoggerPlugin _getPlugin(String name) {
      ...
      try {
         ...
         System.err.println("error while create a new instance. using NullPlugin  _pluginClass: " + Logger._pluginClass.getName() + ". error: " + e.toString());
         e.printStackTrace();
      ...
      try {
         ...
         System.err.println("Unable to init logger plugin. using Null Plugin. name: " + name + ". cause: " + e.toString());
         e.printStackTrace();
         plugin = new NullPlugin();
      }
      return plugin;
   ...
   protected static void init() {
      try {
         ...
         System.err.println("ClassNotFoundException for " + Logger._pluginClassName + ". using NullPlugin. error: " + e.toString());
         Logger._pluginClass = jpl.mipl.mdms.utils.logging.NullPlugin.class;
      } catch (Exception e) {
         System.err.println("General Exception for " + Logger._pluginClassName + ". using NullPlugin. error: " + e.toString());
         e.printStackTrace();
      }
   }
