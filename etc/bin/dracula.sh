...
### ==================================================================== ###
#
# $Id: dracula.sh,v 1.11 2008/07/31 22:58:53 ntt Exp $
#
...
# Set variables
MAIN_CLASS=jpl.mipl.mdms.FileService.spider.dracula.Dracula
USER_OP=spider.util.dracula
...
JVMARGS="${JVMARGS} -Dmdms.user.operation=${USER_OP}"
