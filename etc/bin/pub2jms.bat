...
rem # ==================================================================== ###
rem                                                                          #
rem  Listener program which serves as "glue" bethween FEI and JMS.           #
rem                                                                          #
rem  Function:                                                               #
rem  Listens to a user specified FEI filetype and publishes the content      #
rem  of the incoming text file to JMS.                                       #
rem  It assumes that JBoss JMS implementation is running.                    #
rem                                                                          #
...
rem                                                                          #
rem  Created:                                                                #
rem  Oct. 08, 2004 by C. Radulescu {costin.radulescu@jpl.nasa.gov}           #
rem  Modified:                                                               #
rem  Oct. 26, 2004 by Nick.  Now using the mdmsconfig.bat base setup         #
rem # ==================================================================== ###
rem 
rem $Id: pub2jms.bat,v 1.6 2005/02/03 22:49:47 ntt Exp $
rem 

REM =============================================

REM Set Java class to run with JRE
set LJAVACLASS=jpl.mipl.mdms.FileService.spider.util.PublishToJms
...
set LJVMARGS=%LJVMARGS% -Djava.naming.factory.initial=org.jnp.interfaces.NamingContextFactory 
set LJVMARGS=%LJVMARGS% -Djava.naming.provider.url=jnp://%JAVA_NAMING_HOST%:1099 
set LJVMARGS=%LJVMARGS% -Djava.naming.factory.url.pkgs=org.jboss.naming:org.jnp.interfaces
