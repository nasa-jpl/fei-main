...
### ==================================================================== ###
#                                                                          #
#  Listener program which serves as "glue" bethween FEI and JMS.           #
#                                                                          #
#  Function:                                                               #
#  Listens to a user specified FEI filetype and publishes the content      #
#  of the incoming text file to JMS.                                       #
#  It assumes that JBoss JMS implementation is running.                    #
#                                                                          #
...
### ==================================================================== ###
#
# $Id: pub2jms.sh,v 1.10 2008/07/31 22:58:53 ntt Exp $
#
...
# Set variables
MAIN_CLASS=jpl.mipl.mdms.FileService.spider.util.PublishToJms
...
JVMARGS="${JVMARGS} -Dlog4j.configuration=${FEI5}/mdms.lcf"
JVMARGS="${JVMARGS} -Dlog4j.configuratorClass=org.apache.log4j.xml.DOMConfigurator"
JVMARGS="${JVMARGS} -Djava.naming.factory.initial=org.jnp.interfaces.NamingContextFactory"
JVMARGS="${JVMARGS} -Djava.naming.provider.url=jnp://${JAVA_NAMING_HOST}:1099"
JVMARGS="${JVMARGS} -Djava.naming.factory.url.pkgs=org.jboss.naming:org.jnp.interfaces"
JVMARGS="${JVMARGS} -Dwebservice.uri=http://127.0.0.1:8080/jboss-net/services/DomainEJB"
