...
rem # ==================================================================== ###
rem                                                                          #
rem  SPIDER Client GUI program.                                              #
rem                                                                          #
rem  Function:                                                               #
rem  Listens to JMS for incoming accountability messages                     #
rem                                                                          #
...
rem # ==================================================================== ###
rem
rem $Id: dracula.bat,v 1.6 2005/02/03 22:49:34 ntt Exp $
rem
...
set LJAVACLASS=jpl.mipl.mdms.FileService.spider.dracula.Dracula
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=spider.util.dracula
