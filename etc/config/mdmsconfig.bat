...
REM Check if JAVA_HOME value ends in slash...and remove it.
REM Why? Quoted strings ending in slash can cause issues in CMD, so 
REM this new step removes it if found. (added 2019!)
IF "%JRE_HOME:~-2,-1%"=="\" SET JRE_HOME="%JRE_HOME:~1,-2%"
...
set JVM_ARGS=%JVM_ARGS% -Djavax.net.ssl.trustStorePassword=imfine
