...
public class PublicKeyEncrypter
{
    ...
    {
        // Ensure BC-FIPS provider is registered before constructing CipherUtil.
        // On FIPS-enabled systems, SunPKCS11-NSS-FIPS intercepts RSA cipher
        // requests but does not support OAEPWithSHA-256AndMGF1Padding. BC-FIPS
        // must be at provider priority 1 so CipherUtil.getRsaOaepCipher() uses
        // the correct RSA/NONE/OAEPwithSHA256andMGF1Padding transformation.
