...
public class ReconnectThrottle
{
     ...
     *
     * Update: 2018-12-03: William: fixing security scan : prevent overflow in probationWindowMillis
     */
    protected void checkOverrides()
    {
        ...
        if (propValue != null)
        {
            ...
            {
                long tempProbationWindowMillis = (long) throttleWindowSec * MILLIS_PER_SECOND;
                probationWindowMillis = tempProbationWindowMillis >= Integer.MAX_VALUE ? Integer.MAX_VALUE :
                        (int) tempProbationWindowMillis;
...
//    }
    ...
    /**
     * Update: 2018-12-03: William: fixing security scan - avoiding long = int * int by converting magic numbers to long
     * @param args
     */
    public static void main(String[] args)
    {
        ...
        while (true)
        {
            ...
            if (specialCase)
            {
                sleepTime = 60000L * (randInt*2);
            }
            else
            {
                sleepTime = 60000L * randInt;
            }
