...
public class ServerProxy implements Runnable {
    ...
    *
    * Update: 2018-12-03: William: fixing security scan : prevent overflow in Thread.sleep
    */
       ...
       try {
           ...
           if (this._heartbeatIntervalSec > 0)
           {
               ...
               while (this._alive)
               {
                   ...
                   //sleep
                   if (this._alive)
                       Thread.sleep(_heartbeatIntervalSec * 1000L);
               }
           }
       } catch (InterruptedException e) {
           this._logger.trace(this + " Close immediate has been called, exiting " +
    ...
    * from GETVFT.
    *
    * Update: 2018-12-03: William: fixing security scan - using Stirng.equals
    *
    * @throws SessionException when session failure
    */
   private void _getVFTReferencedFiles() throws SessionException {
      ...
      try {
         ...
         if (!this._currentCmd.getCommand().equals(Constants.GETVFT)) {
            cmd = Constants.PROTOCOLVERSION + " "
                  + this._currentCmd.getCommandString();
...
//                                           "File skipped.");
   ...
   private void _stopSubscription() throws SessionException {
       ...
       if (Objects.isNull(this._currentCmd) || Objects.isNull(this._reqTermHandler) ||
               !this._currentCmd.getCommand().equals(this._currentCntlCmd.getCommand())) {
