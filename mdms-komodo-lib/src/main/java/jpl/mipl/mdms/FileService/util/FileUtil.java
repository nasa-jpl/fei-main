...
public class FileUtil {
    ...
    public static MessageDigest getChecksum(String fileName)
        ...
        try {
            ...
            // SHA-1 not implemented.  Any checksum access attempt will fail.
            // This is not likely to happen anywhere.
            throw new IOException(
                "SHA-1 checksum algorithm not implemented: " + nsa.getMessage());
        }
    ...
    public static String encryptMessage(byte[] msg) {
        // Use "SHA-1" instead of "SHA": BC-FIPS registers only "SHA-1" and "SHA1"
        // as aliases; the bare "SHA" alias is not registered by BC-FIPS and would
        // cause NoSuchAlgorithmException when BC-FIPS is at provider priority 1.
        // "SHA-1" is accepted by both BC-FIPS and the standard SUN provider.
        return encryptMessage(msg,"SHA-1");
    }
