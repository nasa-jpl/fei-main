...
public abstract class SaxXmlParser {
    ...
    private void _parse(InputSource source) throws SAXException, IOException,
        ...
        if (this._validate) {
            ...
            //Update: 2018-12-03: William: fixing security scan - prevent XXE attack.
            // Ref: https://stackoverflow.com/questions/40649152/how-to-prevent-xxe-attack
            // adding additional features to prevent XXE attack.
        ...
        if (this._schema != null) {
            ...
            // effectively ignored).
            parser.setProperty("http://apache.org/xml/properties/schema/external-schemaLocation", _schema);
        }
